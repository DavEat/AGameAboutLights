...
public class AG_LightCaster : MonoBehaviour
{
    ...
    public virtual void Cast(int _currentEmitterIndex, int _colorIndex, Vector2 _origin, Vector2 _hitPoint, Vector2 _normal, float _previousAnimTime, int _lightIndex)
    {
        Debug.Log("virtual");
    } 
	#endregion
